...
docker build -t ghcr.io/nikleberg/quartus_pre-build -f pre_build.dockerfile .
docker create --name quartus_pre-build ghcr.io/nikleberg/quartus_pre-build
docker export quartus_pre-build -o quartus_pre-build.tar
docker rm quartus_pre-build
...
chmod +x tarsplitter
./tarsplitter -i quartus_pre-build.tar -p 5
rm quartus_pre-build.tar
rm tarsplitter
